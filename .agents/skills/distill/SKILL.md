...
Do NOT proceed with speculative design changes when the missing context would materially change the outcome. Simplifying the wrong things destroys usability.
