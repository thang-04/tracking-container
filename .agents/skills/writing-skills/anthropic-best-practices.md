...
Codex may partially read files when they're referenced from other referenced files. When encountering nested references, Claude might use commands like `head -100` to preview content rather than reading entire files, resulting in incomplete information.
...
<CardGroup cols={2}>
  ...
  <Card title="Use Skills in Codex" icon="terminal" href="/en/docs/claude-code/skills">
    Create and manage Skills in Codex
  </Card>
